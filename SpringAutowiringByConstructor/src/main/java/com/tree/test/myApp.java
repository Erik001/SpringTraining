...
public class myApp {
	...
	public static void main(String[] args) {
		...
		Meal mySpringMealAuto = appContext.getBean("mealAutowiredByConstructor", Meal.class);
		System.out.println("Spring meal Autowired by Constructor: " + mySpringMealAuto.whatsInThisMeal());
